 ...
 */
function kidneyDiseaseCalculator(eGFRReadings: GlomerularFiltrationRate[]): string {
...
export { hypertensionCalculator, kidneyDiseaseCalculator, calculateDropsKidney };
